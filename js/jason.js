;(function($,window,document,undefined){
    ...
    var jason = {
            ...
            var topPos   = 124;
                ...
                function resizeFn(){
                    ...
                    if( $window.innerWidth()>1024 ){ //1024초과 모두
                        ...
                        $nav.stop().animate({top:0},0); //처음 로딩시 -1 
                        if(m==1){
                            $nav.stop().show(0);
        ...
        loginSection2Fn:function(){          //로그인 페이지 AJAX PHP MYSQL 구현

        },
        main1_1Fn:function(){          //main1-1 페이지
            ...
            var n = 3;
                ...
                function resizeFn(){
                    ...
                    else{      //860 이하이면 : 이미지 1개
                        n = 1;
                    }
    
                    $section2WrapW = $('#main1-1 #section2 .wrap').innerWidth();  //.wrap 너비  main1-1 영역
                    $section2ImgWrap.css({height: ($section2WrapW/n)*0.6 });  //갤러리 이미지 박스 높이
                    
                    console.log(n);
                    console.log($section2WrapW);
                    console.log(($section2WrapW/n)*0.6);
                }
