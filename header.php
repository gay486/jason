...
<head>
    ...
    <meta name="publisher" content="Choi ahyoung">
    ...
    <!-- 파비콘 -->
    <link rel="shortcut icon" href="./img/img1.png" type="image/ico">
    <link rel="apple-touch-icon" href="./img/img1.png" type="image/ico">
                    ...
                    <ul class="clearfix">
                        ...
                        <li>
                            <ul>
                                ...
                                <li><span><a href="#" class="search-btn"><img src="./img/search_i_01.png" class="white_" alt=""><img src="./img/search_i.png" class="black" alt=""></a></span></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="wrap">
            <div class="gap">
                <div class="container">
                    <ul>
                        <li>
                            <a href="./main1-1.php" class="main-btn">여행테마</a>
                            <div class="sub sub1">
                                <div class="sub-wrap">
                                    <div class="sub-gap">
                                        <ul>
                        ...
                        <li>
                            <a href="./main5-1.php" class="main-btn">여행문의</a>
                            <div class="sub sub2">
                                <div class="sub-wrap">
                                    <div class="sub-gap">
                                        <ul>
                        ...
                        <li>
                            <a href="./main6-1.php" class="main-btn">회사소개</a>
                            <div class="sub sub2">
                                <div class="sub-wrap">
                                    <div class="sub-gap">
                                        <ul>
